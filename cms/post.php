...
<!--                BLOG COMMENTS-->
                ...
                if(isset($_POST['create_comment']) && isset($_GET['p_id'])) {
                    ...
                    $insert_comment_query_result = mysqli_query($connection, $query);
                    
                    
                    if(!$insert_comment_query_result) {
                    ...
                    // INCREASE COMMENT COUNT OF THE POST IN POSTS TABLE
                    ...
                    if(!$increase_comment_count_result) {
                        die("QUERY FAILED".mysqli_error($connection));
                    }
                ...
                if(isset($_GET['p_id'])) {
                    ...
                    $select_comment_query_result = mysqli_query($connection, $query);
